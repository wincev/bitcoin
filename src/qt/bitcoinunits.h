...
/** Solidar unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SolidarUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SolidarUnits(QObject *parent);

    /** Solidar units.
      @note Source: https://en.solidar.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef SolidarUnits::Unit SolidarUnit;
