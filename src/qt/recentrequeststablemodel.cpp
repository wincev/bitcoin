    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return SolidarUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, SolidarUnits::separatorNever);
            else
                return SolidarUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+SolidarUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
