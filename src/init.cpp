 ...
 * between solidard, and solidar-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/solidar/solidar>";
    const std::string URL_WEBSITE = "<https://solidarcore.org>";
...
/** Sanity checks
 *  Ensure that Solidar is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Solidar process is using the data directory.
