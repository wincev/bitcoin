...
class BlockchainTest(SolidarTestFramework):
    ...
    def _test_stopatheight(self):
        ...
        assert_raises(subprocess.TimeoutExpired, lambda: solidard_processes[0].wait(timeout=3))
        self.nodes[0].generate(1)
        self.log.debug('Node should stop at this height...')
        solidard_processes[0].wait(timeout=3)
