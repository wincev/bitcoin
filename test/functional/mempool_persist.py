#!/usr/bin/env python3
# Copyright (c) 2014-2017 The Solidar Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test mempool persistence.

By default, solidard will dump mempool on shutdown and
...
class MempoolPersistTest(SolidarTestFramework):
    ...
    def run_test(self):
        ...
        # Give solidard a second to reload the mempool
        time.sleep(1)
