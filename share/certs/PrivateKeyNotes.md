...
unlocked to sign the Solidar-Qt.app bundle.
...
allowing somebody to distribute a Solidar-Qt.app or solidar-qt-setup.exe with a valid
...
that the solidar-qt.exe file inside the installer had not been tampered with.
