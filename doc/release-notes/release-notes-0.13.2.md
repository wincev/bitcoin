Solidar Core version 0.13.2 is now available from:

  <https://solidar.org/bin/solidar-core-0.13.2/>
...
- #8908 `4a974b2` Update solidar-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow solidar-tx to create v2 transactions (btcdrak)
