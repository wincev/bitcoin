Solidar Core version 0.10.4 is now available from:

  <https://solidar.org/bin/solidar-core-0.10.4/>
...
- #6953 `43c2789` Split solidar-tx into its own package
- #6953 `dfe0d4d` Include solidar-tx binary on Debian/Ubuntu
