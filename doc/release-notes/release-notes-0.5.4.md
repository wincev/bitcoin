Solidar version 0.5.4 is now available for download at:
http://sourceforge.net/projects/solidar/files/Solidar/solidar-0.5.4/
...
http://gitorious.org/solidar/solidard-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Solidar-Qt notifications under Growl 1.3.
Increase required age of Solidar-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSolidar properly when installing Solidar-Qt over it. (Windows)
