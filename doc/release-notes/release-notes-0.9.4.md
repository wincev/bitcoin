Solidar Core version 0.9.4 is now available from:

  https://solidar.org/bin/0.9.4/
...
this update is incompatible with the Solidar system and could lead to consensus
forks.

Solidar Core released binaries from https://solidar.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~solidar/+archive/ubuntu/solidar
- A third-party or self-compiled Solidar Core

upgrade to Solidar Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
