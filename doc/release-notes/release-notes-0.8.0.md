Solidar-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/solidar/files/Solidar/solidar-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Solidar
...
New/changed settings (command-line or solidar.conf file)
--------------------------------------------------------
