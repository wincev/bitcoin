...
This document provides guidelines for internationalization of the Solidar Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `solidar_en.ts` remains unchanged.
